  ...
  return (
    <div className="pt-20 flex flex-col">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Brows by make</h2>
            <Button variant="ghost" className="flex items-center" asChild>
              <Link href="/cars">
                View All <ChevronRight className="ml-1 h-4 w-4" />
              </Link>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Brows by Body Type</h2>
            <Button variant="ghost" className="flex items-center" asChild>
              <Link href="/cars">
                View All <ChevronRight className="ml-1 h-4 w-4" />
              </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
            {bodyTypes.map((type) => {
              return (
                ...
                >
                  <div className="h-28 overflow-hidden rounded-lg flex justify-end mb-4 relative">
                    <Image
                      src={type.image}
                      alt={type.name}
                      fill
      ...
      <section className="py-12 bg-grat-50">
        <div className="container mx-auto px-4">
